...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: zselectradiooption(),
    );
  }
}

class zselectradiooption extends StatefulWidget {
  static const String id = "zselectradiooption";

  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<zselectradiooption> {

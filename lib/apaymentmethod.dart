...
class apaymentmethod extends StatefulWidget {
  static const String id = "dpaymentmethod";

  const apaymentmethod({Key? key}) : super(key: key);

  @override
  State<apaymentmethod> createState() => _dpaymentmethodState();
}

class _dpaymentmethodState extends State<apaymentmethod> {
  @override

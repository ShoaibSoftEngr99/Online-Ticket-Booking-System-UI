...
class aseatselection extends StatefulWidget {
  static const String id = 'aseatselection';

  const aseatselection({Key? key}) : super(key: key);

  @override
  State<aseatselection> createState() => _dseatselectionState();
}

class _dseatselectionState extends State<aseatselection> {
  @override
